...
PSRAM_SRC=$(wildcard $(CORES_DIR)/psram/rtl/*.v)

CORES_SRC=$(ASFIFO_SRC) $(CONBUS_SRC) $(LM32_SRC) $(FMLARB_SRC) $(FMLBRG_SRC) $(CSRBRG_SRC) $(NORFLASH_SRC) $(UART_SRC) $(SYSCTL_SRC) $(HPDMC_SRC) $(VGAFB_SRC) $(MEMCARD_SRC) $(AC97_SRC) $(PFPU_SRC) $(TMU_SRC) $(ETHERNET_SRC) $(FMLMETER_SRC) $(VIDEOIN_SRC) $(DMX_SRC) $(IR_SRC) $(USB_SRC) $(MEMTEST_SRC) $(MONITOR_SRC) $(BRAM_SRC) $(PSRAM_SRC)
